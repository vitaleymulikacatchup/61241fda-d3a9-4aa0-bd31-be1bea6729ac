...
export const metadata: Metadata = {
  title: "Webild - Build Better Websites",
  description: "Discover how Webild is revolutionizing web development with cutting-edge design and intuitive platforms.",
  openGraph: {
    title: "Webild - Build Better Websites",
    description: "Cutting-edge web development with intuitive platforms.",
    siteName: "Webild"
  },
  twitter: {
